...
ht_hash_table *ht_new(void) { return ht_new_sized(HT_INITAL_BASE_SIZE); }
 ...
 * - remove it and it will brak the chain, thus finding the other items will be
 * impossible
 * - solution: do not delete, MARK as deleted (replace with a pointer to a
 * global sentinel)
 */
